...
namespace TelegramBot.Commands
{
    public class AddWordCommand : AbstractCommand
    {
        ...
        private Dictionary<long, EnglishTrainer.Model.Word> Buffer;
        ...
        public AddWordCommand(ITelegramBotClient botClient)
        {
            ...
            Buffer = new Dictionary<long, EnglishTrainer.Model.Word>();
        }

        public async void StartProcessAsync(Conversation chat)
        {
            Buffer.Add(chat.GetId(), new EnglishTrainer.Model.Word());
